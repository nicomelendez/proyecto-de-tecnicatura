...
import com.servidor.entidades.EventoTutor;
import com.servidor.entidades.EventoTutorPK;
...
public class EventoBean implements EventoBeanRemote {
	...
	public boolean asignarTutorAEvento(Evento oEvento, Tutor oTutor) {
		try {
			...
			EventoTutorPK oEventoTutorPK = new EventoTutorPK(oEvento.getIdEvento(), oTutor.getIdTutor());
